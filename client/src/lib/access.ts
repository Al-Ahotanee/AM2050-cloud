...
export const modules: ModuleLink[] = [
  ...
  { key: "attendance", label: "Attendance", path: "/attendance", icon: ClipboardCheck, roles: ["super_admin", "program_admin", "lga_supervisor", "ward_supervisor", "headmaster", "teacher", "mobilizer"] },
  ...
  { key: "users", label: "User management", path: "/users", icon: UserCog, roles: ["super_admin", "program_admin"] },
